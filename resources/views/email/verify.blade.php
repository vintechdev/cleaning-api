...
<p>
  <a style="text-decoration: none;background: #52b68d;color: #fff;padding: 5px 10px;border-radius: 3px;"
     href="<?php  echo route('verifyEmail',['id'=>$data->id,'v_code'=>$key]); ?>">{{__('Verify')}}</a>
</p>
<p>
