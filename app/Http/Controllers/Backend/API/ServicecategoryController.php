...
class ServicecategoryController extends Controller
{
    ...
    public function get_all_servicecategory(Request $request)
    {
      ...
      $servicecategories = Servicecategory::select('id','uuid','name','icon','allow_multiple_addons','description','created_at','updated_at','deleted_at')->where('active', 1)->orderby('position','ASC');
